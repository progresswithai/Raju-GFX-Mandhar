...
async function run() {
  ...
  for (const imgUrl of images) {
    ...
    if (imgUrl.startsWith('https://rajugfx.in')) {
      localSubPath = imgUrl.replace('https://rajugfx.in', '');
    } else if (imgUrl.startsWith('http://rajugfx.in')) {
      localSubPath = imgUrl.replace('http://rajugfx.in', '');
    } else if (imgUrl.startsWith('//rajugfx.in')) {
      localSubPath = imgUrl.replace('//rajugfx.in', '');
    }
  ...
  for (const item of toRestore) {
    const liveUrl = `https://rajugfx.in${item.subPath}`;
